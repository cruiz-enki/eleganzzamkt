...
export function IAGenerator() {
  ...
  const [selectedType, setSelectedType] = useState<(typeof CREATIVE_TYPES)[number]["id"] | null>(
    null,
  );
                            ...
                            <div className="flex items-center justify-between mb-2">
                              <div className="flex items-center gap-2">
                                ...
                                {item.status === "draft" ? (
                                  <Badge
                                    variant="secondary"
                                    className="bg-amber-100 text-amber-700 border-0 text-[8px] uppercase font-bold"
                                  >
                                    Borrador
                                  </Badge>
                                ) : (
                                  <Badge
                                    variant="secondary"
                                    className="bg-emerald-100 text-emerald-700 border-0 text-[8px] uppercase font-bold"
                                  >
                                    Publicado
                                  </Badge>
                                )}
