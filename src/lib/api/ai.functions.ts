    ...
    return createOpenAITextResponse([
      {
        ...
        content:
          data.systemMessage ||
          "Eres un experto en marketing para una marca de muebles de lujo llamada Eleganzza Muebles. Crea copys atractivos y profesionales.",
      },
      {
        role: "user",
        content: data.prompt,
    ...
    return createOpenAITextResponse([
      {
        ...
        content: [
          {
            type: "text",
            text: "Analiza esta imagen de un mueble. Mi objetivo es tener una imagen limpia para catálogo: sin fondos distractores, sin textos y sin marcas de agua. Describe detalladamente cómo debería verse la versión final procesada.",
          },
