  ...
  return (
    <div className="min-h-screen bg-[#fcfbf8] p-6 lg:p-10">
      ...
      <Tabs defaultValue="dashboard" className="w-full">
        <TabsList className="mb-8 bg-white/50 border border-slate-200">
          <TabsTrigger value="dashboard" className="data-[state=active]:bg-white">Dashboard</TabsTrigger>
          <TabsTrigger value="productos" className="data-[state=active]:bg-white">Productos</TabsTrigger>
        </TabsList>
          ...
          <BentoGrid>
            ...
            >
              <div className="mt-2">
                ...
                <button 
                  onClick={() => document.querySelector<HTMLButtonElement>('[value="productos"]')?.click()}
